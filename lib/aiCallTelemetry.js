...
export function runWithAiTelemetryContext(context = {}, fn) {
  ...
  // Create the additive telemetry schema on the first API request for that user, not on the first
  // paid model call, so schema inventories/diagnostics see a stable table set.
