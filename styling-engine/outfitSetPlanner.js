...
function planWorkbenchPieceLine(piece = {}) {
  ...
  const bits = [
    ...
    piece.sleeve_length ? `sleeve_length:${piece.sleeve_length}` : '',
    piece.sleeve_shape && piece.sleeve_shape !== 'other' && piece.sleeve_shape !== 'unknown' ? `sleeve_shape:${piece.sleeve_shape}` : '',
