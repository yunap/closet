...
- Thermal Adequacy & Exposure Duration: Outdoor walking (e.g. 2–3 hours in 46°F wind) is prolonged cold exposure with convective wind-chill. An uninsulated lightweight shell (warmth:light) over a single top is suited for 55°F–65°F, not extended sub-50°F cold. Cold outdoor exposure requires real upper-body insulation: choose an insulating coat (warmth:warm or warmth:very warm) over a top or thin knit base, OR construct an intentional 3-layer system with a middle knit layer (assigned role 'layer_top', such as a cardigan, vest, or sweater) beneath a lightweight outer jacket. Do NOT layer a cardigan under a warm coat or puffer—stacking a heavy outer coat over a cardigan causes thermal overshoot and uncomfortable sleeve binding. Standalone uninsulated shells without a middle layer are not warm enough on their own for cold outdoor exposure.
...
- Layering & Sleeve Physics: Follow sleeve layering compatibility: a structured or narrow outer sleeve cannot accommodate an inner sleeve with excess volume (puff, gathered/ruched, voluminous, or flared), but generous, relaxed cuts and roomy puffer coats have space to accommodate layered sleeves without binding.
