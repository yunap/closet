...

{
  ...
  "fiber_content": ["array of visible/likely fibers/materials from this canonical list only: wool, merino, cashmere, alpaca, mohair, fleece, down, cotton, linen, hemp, silk, tencel, modal, rayon, viscose, polyester, nylon, acrylic, spandex, leather, suede, denim, metal, stone, wood, ceramic, glass, horn, shell, resin, unknown. metal/stone/wood/ceramic/glass/horn/shell/resin are for accessory/jewelry pieces (not textile fibers, but this field is a functional material classification, not literal fiber composition — same reason leather/suede/denim are on this list). Use 'horn' or 'shell' for genuine or imitation horn/shell-look buttons, buckles, and hardware; use 'resin' for cast/molded plastic-look hardware that isn't clearly 'synthetic' textile. Use 'tencel' for lyocell/Tencel fabric — there is no separate 'lyocell' value, they are the same stored concept. You MUST align this list with your fabric_category (e.g. if fabric_category is silk, fiber_content must include silk; if fabric_category is metal, fiber_content must include metal). Use 'unknown' if not determinable."],
