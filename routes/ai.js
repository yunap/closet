  ...
  "pieces": [
    {
      ...
      "fiber_content": ["array of visible/likely fibers/materials from this canonical list only: wool, merino, cashmere, alpaca, mohair, fleece, down, cotton, linen, hemp, silk, tencel, modal, rayon, viscose, polyester, nylon, acrylic, spandex, leather, suede, denim, metal, stone, wood, ceramic, glass, unknown. metal/stone/wood/ceramic/glass are for accessory/jewelry pieces. Use 'tencel' for lyocell/Tencel fabric — there is no separate 'lyocell' value. Use 'unknown' if not determinable."],
