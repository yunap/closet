  ...
  "pieces": [
    {
      ...
      "fiber_content": ["array of visible/likely fibers/materials from this canonical list only: wool, merino, cashmere, alpaca, mohair, fleece, down, cotton, linen, hemp, silk, tencel, modal, rayon, viscose, polyester, nylon, acrylic, spandex, leather, suede, denim, metal, stone, wood, ceramic, glass, horn, shell, resin, unknown. metal/stone/wood/ceramic/glass/horn/shell/resin are for accessory/jewelry pieces. Use 'tencel' for lyocell/Tencel fabric — there is no separate 'lyocell' value. Use 'unknown' if not determinable."],
